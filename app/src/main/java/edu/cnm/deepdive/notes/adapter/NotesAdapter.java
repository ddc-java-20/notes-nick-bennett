...
public class NotesAdapter extends Adapter<ViewHolder> {
  ...
  public NotesAdapter(Context context, List<Note> notes, OnLongClickListener listener) {
    this.notes = notes;
    ...
    public void bind(int position, Note note) {
      ...
      binding.getRoot().setOnLongClickListener(new View.OnLongClickListener() {
        ...
        public boolean onLongClick(View view) {
          return listener.onLongClick(view, note, position); // TODO: 2/17/2025 Invoke listener provided by UI controller.
        }
      });
    }
